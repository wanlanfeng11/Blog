...
public class AdminLoginServiceImpl implements AdminLoginService {
    ...
    public ResponseResult login(User user) {
        ...
        //把用户信息存入redis
        redisCache.setCacheObject(SystemConstants.ADMIN_USER_KEY +userId,loginUser);
    ...
    public ResponseResult logout() {
        ...
        //删除redis中对应的值
        redisCache.deleteObject(SystemConstants.ADMIN_USER_KEY + userId);
